...
public class SignalKRX {
	...
	public static enum SignalKPath {
		...
		DECK_LIGHTS_SWITCH("electrical.switches.bank.0.deck_lighting.state", Optional.empty(), Optional.empty(),
				new char[] { 'p', 'u', 'v' }, true),
		...
		WASTE_WATER_SWITCH("electrical.switches.bank.0.waste_water.state", Optional.empty(), Optional.empty(),
				new char[] { 'h' }, true),
		WASH_DOWN_SWITCH("electrical.switches.bank.0.wash_down.state", Optional.empty(), Optional.empty(),
				new char[] { 'i' }, true),
