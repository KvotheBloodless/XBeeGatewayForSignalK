...
public class SignalKRX {
	...
	public static enum SignalKPath {
		...
		DECK_LIGHTS_SWITCH("electrical.switches.bank.0.2.state", Optional.empty(), Optional.empty(),
				new char[] { 'p', 'u', 'v' }, true),
		...
		REFRIGERATION_SWITCH("electrical.switches.bank.0.refrigeration.state", Optional.empty(), Optional.empty(),
				new char[] { 'l' }, true),
		INSTRUMENTATION_SWITCH("electrical.switches.bank.0.4.state", Optional.empty(), Optional.empty(),
				new char[] { 's' }, true),
		WASTE_WATER_SWITCH("electrical.switches.bank.0.waste_water.state", Optional.empty(), Optional.empty(),
				new char[] { 'h' }, true),
		WASH_DOWN_SWITCH("electrical.switches.bank.0.3.state", Optional.empty(), Optional.empty(),
				new char[] { 'i' }, true),
		RADIOS_SWITCH("electrical.switches.bank.0.radios.state", Optional.empty(), Optional.empty(),
				new char[] { 't' }, true),
		AUTOPILOT_SWITCH("electrical.switches.bank.0.autopilot.state", Optional.empty(), Optional.empty(),
				new char[] { 'r' }, true),
		HYDRAULICS_SWITCH("electrical.switches.bank.0.1.state", Optional.empty(), Optional.empty(),
				new char[] { 'c' }, true),
