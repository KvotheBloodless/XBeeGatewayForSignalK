...
public class SignalKRX {
	...
	public static enum SignalKPath {
		...
		DECK_LIGHTS_SWITCH("electrical.switches.bank.0.1.state", Optional.empty(), Optional.empty(),
				new char[] { 'p', 'u', 'v' }, true),
		...
		WASTE_WATER_SWITCH("electrical.switches.bank.0.waste_water.state", Optional.empty(), Optional.empty(),
				new char[] { 'h' }, true),
		WASH_DOWN_SWITCH("electrical.switches.bank.0.2.state", Optional.empty(), Optional.empty(),
				new char[] { 'i' }, true),
		RADIOS_SWITCH("electrical.switches.bank.0.radios.state", Optional.empty(), Optional.empty(),
				new char[] { 't' }, true),
		AUTOPILOT_SWITCH("electrical.switches.bank.0.3.state", Optional.empty(), Optional.empty(),
				new char[] { 'r' }, true),
		HYDRAULICS_SWITCH("electrical.switches.bank.0.0.state", Optional.empty(), Optional.empty(),
				new char[] { 'c' }, true),
